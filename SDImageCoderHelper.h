 ...
 */
+ (UIImage.Orientation)imageOrientationFromEXIFOrientation:(CGImagePropertyOrientation)exifOrientation NS_SWIFT_NAME(imageOrientation(from:));
 ...
 */
+ (CGImagePropertyOrientation)exifOrientationFromImageOrientation:(UIImage.Orientation)imageOrientation;
#endif
